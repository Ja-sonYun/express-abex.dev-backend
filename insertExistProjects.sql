...
--INSERT INTO PROJECTS (title, url, description, status) VALUES ('Limited Access Link Generator', 'lalg.abex.dev', 'Generate limited access link. If you set the limit 2, generated link will be disconnected from origin url when 2 people visit generated url. (Pure JavaScript)', 'Done..?');
